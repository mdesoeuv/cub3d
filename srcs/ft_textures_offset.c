...
/*   Updated: 2022/02/28 16:31:22 by vchevill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_texture_x_offset(t_cub3d *cub3d, double ray_abs_angle)
{
	...
	if (ray_abs_angle > 0 && ray_abs_angle < (M_PI / 2))
		return (CUB_SIZE - ((int)((cub3d->ray_length * cos(alpha))
				- (CUB_SIZE - (cub3d->player.x % CUB_SIZE))) % CUB_SIZE));
	else if (ray_abs_angle > (3 * M_PI / 2) && ray_abs_angle < 2 * M_PI)
		return (CUB_SIZE - ((int)(cub3d->ray_length * cos(alpha)
				- (CUB_SIZE - (cub3d->player.x % CUB_SIZE))) % CUB_SIZE));
	else if (ray_abs_angle > M_PI / 2 && ray_abs_angle < M_PI)
		return ((int)((cub3d->ray_length * cos(alpha))
...
int	ft_texture_y_offset(t_cub3d *cub3d, double ray_abs_angle)
{
	...
	if (ray_abs_angle > M_PI / 2 && ray_abs_angle < (M_PI))
		return ((int)((cub3d->ray_length * sin(alpha))
			- (cub3d->player.y % CUB_SIZE)) % CUB_SIZE);
	else if (ray_abs_angle > (0) && ray_abs_angle < M_PI / 2)
		return (CUB_SIZE - ((int)(cub3d->ray_length * sin(alpha)
