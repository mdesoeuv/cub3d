...
/*   Updated: 2022/02/23 16:51:10 by vchevill         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
	dprintf(1, "%s\n",texture_name);
	image_struc->ptr = mlx_xpm_file_to_image(cub3d->mlx, "./textures/wall_1.xpm", &(image_struc->width), &(image_struc->height));
	if(!image_struc->ptr)
